var Constant = 
{
    ...
    Tech:{
        ...
        2:{id:2,name:"散射1",icon:"tech_2",    x:-60, y:250,  m_type:2,param:[0,3],needId:1},
        3:{id:3,name:"散射2",icon:"tech_3",x:60,  y:250,      m_type:2,param:[0,5],needId:2},
        4:{id:4,name:"散射3",icon:"tech_4", x:180, y:250,     m_type:2,param:[0,7],needId:3},
        5:{id:5,name:"贯通1",icon:"tech_1", x:-60,  y:150,    m_type:2,param:[0,2],needId:1},
        6:{id:6,name:"贯通2",icon:"tech_2",x:60,y:150,        m_type:2,param:[0,4],needId:5},
