var Constant = 
{
    ...
    Tech:{
        ...
        9:{id:9,name:"充能炮",icon:"tech_9",x:-195,y:10,      m_type:1,param:[3,30],needId:[0],repel:null,},
        10:{id:10,name:"冷却1",icon:"tech_10",x:-65,y:10,       m_type:2,param:[3,20],needId:[9],repel:null,},
        11:{id:11,name:"冷却2",icon:"tech_11",x:65,y:10,     m_type:2,param:[3,10],needId:[10],repel:null,},
        12:{id:12,name:"急冷",icon:"tech_12",x:195,y:10,      m_type:2,param:[4,0],needId:[11],repel:null,},

        13:{id:13,name:"轰炸",icon:"tech_13",x:-195,y:-120,  m_type:2,param:[6,1],needId:[0],repel:null,},
        14:{id:14,name:"折跃",icon:"tech_14",x:-65,y:-120,  m_type:2,param:[6,2],needId:[13],repel:null,},

        15:{id:15,name:"僚机X1",icon:"tech_15",x:65,y:-120,  m_type:2,param:[5,1],needId:[0],repel:null,},
        16:{id:16,name:"僚机X2",icon:"tech_16",x:195,y:-120,  m_type:2,param:[5,2],needId:[15],repel:null,},
    },
}
